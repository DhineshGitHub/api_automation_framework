...
public class LoggingFilter implements Filter {
	...
	public Response filter(FilterableRequestSpecification requestSpec, FilterableResponseSpecification responseSpec,
			FilterContext ctx) {
		loggingFilterRequest(requestSpec);
		Response response = ctx.next(requestSpec, responseSpec);
		loggingFilterResponse(response);
		return response;
	}

	public void loggingFilterRequest(FilterableRequestSpecification requestSpec) {
	...
	public void loggingFilterResponse(Response response) {
